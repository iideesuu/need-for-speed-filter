...
NFS Lab 是一个完全在浏览器本地运行的 Y2K / lo-fi 数码影像滤镜工具，视觉方向来自早期消费级数码相机、夜间闪光、高速公路灯光、褪色印刷和低分辨率彩色噪点。
...
- 8 个内置风格预设：4 个原版高清滤镜，以及对应的 4 个低分辨率噪点版本。
- 风格覆盖紫调速度封面、黄昏高架、硬闪抓拍、褪色印刷、粗颗粒和彩色传感器噪声。
