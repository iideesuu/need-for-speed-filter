...
NFS Lab 是一个完全在浏览器本地运行的 Y2K / 富士胶片 / CCD 数码影像滤镜工具，视觉方向来自早期消费级数码相机、夜间闪光、高速公路灯光、褪色印刷，以及经典胶片模拟的色彩与颗粒。
...
- 24 个内置风格预设，分为 Y2K 风格、富士胶片与 CCD 风格三组；Y2K 组包含 4 个原版高清滤镜及对应的 4 个低分辨率噪点版本。
- 富士胶片组包含 PROVIA、Velvia、ASTIA、Classic Chrome、Classic Neg、Nostalgic Neg.、ETERNA 和 ACROS 八种常见模拟风格。
- CCD 组包含日系冷白、奶油柔光、冰蓝夜景、暖黄室内、复古绿偏、霓虹街头、红眼派对和早期手机八种风格。
- 风格覆盖紫调速度封面、黄昏高架、硬闪抓拍、经典胶片色彩、CCD 直闪偏色、电影低反差和黑白颗粒。
- 支持点击或拖拽上传，并可在效果图与原图之间快速切换。
- 支持 `1:1`、`4:5` 和原始比例三种画幅。
- 提供曝光、反差、饱和度、色温、紫红 / 绿偏、高光溢出、运动拖影、低清晰度、亮度噪点、噪点粗糙度、彩色噪声、褪色、柔焦、暗角和色差调节。
